...
{
 SDL_LockMutex(RENDERER_MUTEX);
 SDL_SetRenderDrawColor(RENDERER,_color.r,_color.g,_color.b,0xFF);
...
{
 SDL_Rect dummy={_rect.x-thickness,_rect.y,thickness,_rect.h+thickness};
 FillRect(dummy,_color,_screen);
 dummy={_rect.x,_rect.y+_rect.h,_rect.w+thickness,thickness};
 FillRect(dummy,_color,_screen);
 dummy={_rect.x+_rect.w,_rect.y,thickness,_rect.h+thickness};
 FillRect(dummy,_color,_screen);
 dummy={_rect.x-thickness,_rect.y-thickness,_rect.w+2*thickness,thickness};
 FillRect(dummy,_color,_screen);
}
